 ...
 //Graph Y=F(x)
  ...
  begin
   //Display result
    ...
    if (pointNo>j) then
    begin
     showmessage('The bigest no point of max is '+inttostr(j)+' !!!');
     goto stop2;
    end;
    ...
    ResultMemo.Lines.Add(#13#10+'The highest Y Maximum is '+floattostr(highestYmax)+
   ...
   begin
    ...
    if (pointNo>l) then
    begin
     showmessage('The bigest no point of min is '+inttostr(l)+' !!!');
     goto stop2;
    end;
    ...
    ResultMemo.Lines.Add(#13#10+'The lowest Y Minimum is '+floattostr(lowestYmin)+
...
const
 sAbout = '|======== Multi-Critical Point Finder ========|' + #13#10 +
          '' + #13#10 +
          'Version 1.1 - build Jan 18, 2025'+ #13#10 +
